class HomeController < ApplicationController
  ...
  require 'unirest'
    ...
    def chat_control
        ...
        "N14 : 경영대, 테니스장, 미술관과 인접해있는 건물이다. N14(건물번호)라고 흔히 불린다. 2009년에 완공되었다. 이 건물이 생기기 이전에는 교양강의 대부분을 각 단과대학 강의실에서 했으나, 완공 이후 교양강의 대부분을 이곳에서 한다. 교수연구실 일부를 제외하고 전부 강의실로만 구성되어 있고, 신식 건물이라 단과대 건물에 비하면 시설이 매우 좋은 편이다. 다만 일부 강의실에 비치된 3명씩 앉는 책상이 좀 불편한 점이 있고 냉난방 장치가 중앙제어 시스템이라 여름엔 무지하게 덥다.반면 겨울엔 히터를 잘 틀어주는 편이다.(어?)",
        ...
        "제1본관 : 충북대학교의 역사가 담겨 있는 상징적인 건물이기에 한동안 남겨두었으나, 점차 사용하지 않아 관리가 안되어 밤에 가면 좀 무서워보이기도 했다. 그 때문인지 2011년 축제 기간에는 귀신의 집 건물로 이용되기도 했다.",
        ...
        "탈마당(야외공연장,S8) : 양성재 기숙사 근처에 위치하고 있다. 정식 명칭은 야외공연장이며, 스테이지 및 넓은 공터로 구성되어 있다. 참고로 과거 동아리방 건물(11동)이 있던 자리는 탈마당이 아닌 풋살경기장. 무대시설 아래쪽은 공터로 되어있어 줄넘기나 가벼운 운동을 사람들이 꽤 많다. 또한 기숙사 가요제나 동아리 가요제, 일부 단과대 행사가 이곳에서 열리기도 한다.",
